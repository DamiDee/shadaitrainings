...
<body>
  <a href="javascript:history.back()" class="back-button"
    style="color: white; position:relative; bottom:330px; right:200px; text-decoration:none;">
    <span>Back</span>
  </a>
  <div class="container">
    <div class="cover">
    ...
    <div class="forms">
      <div class="form-content">
        ...
        @endif
              ...
              <div class="text forgot-password-text" style="text-align: right; margin-bottom: 15px;">
                <a href="{{ route('forgotPasswordForm') }}" style="text-decoration: none; color: #007bff;">Forgot
                  Password?</a>
              </div>
