            ...
            <div class="row">
                        ...
                        <div class="content">
                            ...
                            <ul class="course_list">
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Recognize symptoms of mental illness.</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Describe characteristics of mental illness.</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>List treatments and care measures formental illness.</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Discuss medicines used in thetreatment of mental illnesses.</p>
                                </li>
                ...
                <div class="col-lg-4 right-contents">
                    <div class="sidebar_top">
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Course Name </p>
                                    <span style="color:green; font-weight: bold">Mental Retardation</span>
                                </a>
                            </li>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                        ...
                        <a href="{{ route('mentalRetardation') }}" class="btn_1 d-block">Start Course</a>
                    </div>
