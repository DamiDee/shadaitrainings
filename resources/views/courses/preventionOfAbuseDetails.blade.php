                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item">
                            ...
                            <p>Home/Prevention of Abuse, Neglect and Exploitation</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    ...
                    <div class="content_wrapper">
                        ...
                        <div class="content">
                           <p>
                           The objectives for this training are for the participant to:
                           </p>
                        </div>
                        ...
                        <div class="content">
                            ...
                            <ul class="course_list">
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Define what abuse, neglect and exploitation is</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Recognize signs of each</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Identify steps for reporting</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Take steps towards prevention.</p>
                                </li>
                ...
                <div class="col-lg-4 right-contents">
                    <div class="sidebar_top">
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Course Name </p>
                                    <span style="color:green; font-weight: bold">Prevention of abuse, neglect and exploitation of a participant</span>
                                </a>
                            </li>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                        ...
                        <a href="{{ route('preventionOfAbuse') }}" class="btn_1 d-block">Start Course</a>
                    </div>
