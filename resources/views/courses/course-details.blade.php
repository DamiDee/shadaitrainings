            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    ...
                    <div class="content_wrapper">
                        ...
                        <div class="content">
                            This lesson contains information about oxygen therapy. Most state regulatory bodies allow aides or personal care attendants to assist with oxygen therapy, although a few do not permit it. Use this material according to the rules in your state. Even if your workers do not assist with oxygen, they may assist a resident who is able to set liter flow or use oxygen independently, making this knowledge useful.
                            <br>
                            <br>
                            At the conclusion of this lesson, a participant will be able to: <br>
                            • Explain the body’s normal mechanism for processing oxygen <br>
                            • Describe conditions for which supplemental oxygen is used <br>
                            • Recognize the different types of delivery systems for oxygen therapy
                        </div>

                        <h4 class="title">Learning Guide</h4>
                        <div class="content">
                            Print a learning guide, test, and certificate for each participant. Using the learning guide, deliver a brief lecture on the body’s normal mechanism for processing oxygen within the body, explaining what happens when oxygenation is poor and supplemental oxygen therapy must be used. Define the italicized words in the learning guide to be sure participants understand them.
                            Review the different delivery systems generally used for the delivery of oxygen therapy 
                            (oxygen concentrators, portable tanks, liquid oxygen). 
                            If possible, ask a local oxygen or medical equipment supplier to bring 
                            different types of equipment to teach participants how to turn on the 
                            supply and set liter flow, allowing time for practice.
                            <br>
                        ...
                        <div class="content">
                            <ul class="course_list">
                                ...
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Basics of Oxygen</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>How a healthy person processes oxygen</p>
                                ...
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Obtaining oxygen equipment</p>
                                ...
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Types of oxygen delivery systems</p>
                        ...
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Course Name </p>
                                    <span style="color:green; font-weight: bold">Oxygen Training On-Boarding</span>
                                </a>
                            </li>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
