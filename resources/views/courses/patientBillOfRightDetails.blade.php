                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item">
                            ...
                            <p>Home/Patient Bill Of Rights</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    ...
                    <div class="content_wrapper">
                        ...
                        <div class="content">
                           <p>
                               Patient Rights are an integral part of healthcare today. 
                               All clients come to our Agency with different healthcare 
                               experiences and may or may not be aware of their rights. 
                               Protections are afforded by federal and state  legislation 
                               and as health care providers we must educate our client about 
                               their rights and the manner in which  they may exercise them. 
                               For ease of access and teaching, the patient’s rights are clearly 
                               stated in one document  that is called The Patient’s Bill of Rights.
                           </p>
                        </div>
                ...
                <div class="col-lg-4 right-contents">
                    <div class="sidebar_top">
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Course Name </p>
                                    <span style="color:green; font-weight: bold">PATIENT BILL OF RIGHTS INSERVICE</span>
                                </a>
                            </li>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                        ...
                        <a href="{{ route('patientBillOfRight') }}" class="btn_1 d-block">Start Course</a>
                    </div>
