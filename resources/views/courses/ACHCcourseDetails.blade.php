            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    ...
                    <div class="content_wrapper">
                        ...
                        <h4 class="title">INSTRUCTIONS FOR COMPLETION:</h4>
                        <div class="content">
                           <ol>
                            <li>This training packet will be completed on hire and annually for all direct care employees.</li>
                            <li>The employee will read the materials included and complete the post test.</li>
                            <li>An office employee will grade the test and determine that the employee has successfully comprehended the information by at least a 75% passing score on the test.</li>
                            <li>The training certificate will be completed and the post-test along with the certificate will be placed in the personnel file.</li>   
                        </ol>
                        </div>
                        ...
                        <div class="content">
                            <ul class="course_list">
                                ...
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Emergency/Disaster</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>How to handle complaints/grievances</p>
                                ...
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Workplace/Patient safety (OSHA)</p>
                                ...
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>TB/Blood borne Pathogens</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Medical Device Act</p>
                ...
                <div class="col-lg-4 right-contents">
                    <div class="sidebar_top">
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Course Name </p>
                                    <span style="color:green; font-weight: bold">ACHC</span>
                                </a>
                            </li>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                        ...
                        <a href="{{ route('oxygenTraining') }}" class="btn_1 d-block">Start Course</a>
                    </div>
