...
<body>
    ...
    <script>
        const quizData = [
        {
            question: "1. Name three health problems that can occur because of lack of activity and exercise._______________ _____________, __________________, __________________",
            a: "A.  Diabetes",
            b: "B.  Stroke",
            c: "C.  Heart disease",
        ...
        {
            question: "2. Progressive loss of muscle mass occurs at an average rate of ___________ percent per decade from 25 to 50 years and ____________ percent per decade thereafter.",
            a: "A. 6%, 12%",
            b: "B. 3%, 8%",
            c: "C. 4%, 10%",
            d: "D. 5%, 15%",
        ...
        {
            question: "3. Older persons’ muscles, joints, and ligaments are more prone to injury.",
            a: "A. true",
            b: "B. false",
            c: "C. i don't know",
            d: "D. all of the above",
        ...
        {
            question: "4. Research confirms that regular exercise can slow or reverse many changes associated with the age-related loss of strength, endurance, and flexibility.",
            a: "A. true",
            b: "B. false",
            c: "C. i don't know",
            d: "D. all of the above",
        ...
        {
            question: "5. ____________________ _______ ____________________ exercises are used to keep joints, muscles, ligaments, and tendons loose and flexible.",
            a: "A. Stretching and sitting",
            b: "B. Cardiovascular and joint",
            c: "C. Strength and training",
            d: "D. Range of motion",
            correct: "d"
        },
        {
            question: "6. Even a small change in muscle size can make a difference in strength.",
            a: "A. true",
            b: "B. false",
            c: "C. I don't know",
        ...
        {
            question: "7. ____________________________ benefits people of all ages.",
        ...
        {
            question: "8. Regular exercise, even in short sessions several times a week, can help to offset a variety of health problems.",
            a: "A. false",
            b: "B. true",
            c: "C. i don't know",
            d: "D. none of the above",
        ...
        {
            question: "9. When confined to bed, clients should change positions at least every_________________________ hours.",
            a: "A. Four",
            b: "B. Two",
            c: "C. Eight",
            d: "D. Six",
        ...
        {
            question: "10. Daily activities move joints through their full range of motion.",
            a: "A. true",
            b: "B. false",
            c: "C. i don't know",
            d: "D. none of the above",
...
function displaySummary() {
    ...
    quizContainer.innerHTML = `
        ...
        ${percentage >= 70 ? '<button><a href="{{ route("showCertForRangeOfMotion") }}">Generate Certificate</a></button>' : ''}
