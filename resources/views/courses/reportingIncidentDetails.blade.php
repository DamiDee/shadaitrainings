            ...
            <div class="row">
                        ...
                        <div class="content">
                            ...
                            <ul class="course_list">
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Know the standard procedures to report incidents</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Recognize Incidents categories</p>
                ...
                <div class="col-lg-4 right-contents">
                    <div class="sidebar_top">
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Course Name </p>
                                    <span style="color:green; font-weight: bold">Critical Incident Reporting</span>
                                </a>
                            </li>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                        ...
                        <a href="{{ route('reportingIncident') }}" class="btn_1 d-block">Start Course</a>
                    </div>
