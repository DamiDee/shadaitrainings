            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    ...
                    <div class="content_wrapper">
                        <h4 class="title_top">Learning objectives</h4>
                        <div class="content">
                           <p>Participants in this lesson will be able to
                            • Define seizure, seizure disorder, and epilepsy.
                            • Recognize when someone is having a seizure and respond appropriately.
                            • List care measures for people on anticonvulsant medications.
                            • List risk factors for strokes.
                            • State the most common symptoms of stroke.
                            • Recognize the symptoms of stroke and respond appropriately.
                         </p>
                        </div>

                        <h4 class="title">Introductory activity</h4>
                        <div class="content">
                            <p>
                            Distribute a copy of the learning activity to each participant. Ask them to read the
                            stories and write or say how they would respond. This can be done as a group
                            discussion or as an individual activity. It is likely that many of the learners will not know
                            the answers. Reassure them that they will learn how to respond to these important
                            situations in today’s lesson. The answers are given on the separate learning activity answer key.
                            </p> 
</div>
                <div class="col-lg-4 right-contents">
                    <div class="sidebar_top">
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Course Name </p>
                                    <span style="color:green; font-weight: bold">Seizures and strokes</span>
                                </a>
                            </li>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                        ...
                        <a href="{{ route('strokeAndSeizure') }}" class="btn_1 d-block">Start Course</a>
                    </div>
