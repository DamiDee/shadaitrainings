            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    ...
                    <div class="content_wrapper">
                        ...
                        <div class="content">
                           <p>
                           Participants completing this lesson will be able to:
                           </p>
                        </div>
                        ...
                        <div class="content">
                            ...
                            <ul class="course_list">
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Understand the four disease transmission
                                    categories.</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Understand Standard Precautions and how and when they should be used.</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Understand Additional Precautions and how and when they should be used.</p>
                                   
                                </li>
                                <li class="justify-content-between align-items-center d-flex">
                                    <p>Be able to apply
                                    this understanding at work.</p>
                                </li>
                ...
                <div class="col-lg-4 right-contents">
                    <div class="sidebar_top">
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Course Name </p>
                                    <span style="color:green; font-weight: bold">Infection Control</span>
                                </a>
                            </li>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                        ...
                        <a href="{{ route('infectionControl') }}" class="btn_1 d-block">Start Course</a>
                    </div>
