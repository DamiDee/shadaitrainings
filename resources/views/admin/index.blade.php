        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 grid-margin">
                <a href="{{ route ('admin.completedCourses')}}" style="text-decoration:none; color:white">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span class="ps-2">{{ $user->firstname }}</span>
                                </td>
                                <td>{{ $user->lastname }}</td>
                                <td>{{ $user->email }}</td>
                                ...
                                <button type="button" class="btn btn-secondary view-activity-btn" data-user-id="{{ $user->id }}" data-user-name="{{ $user->firstname }} {{ $user->lastname }}">View Activity</button>
                             
                                 
                                  <!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#makeAdminModal" data-user-id="{{ $user->id }}">
                                      Make Admin
                                  </button> -->
...
</span>  <!-- <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="https://www.bootstrapdash.com/bootstrap-admin-template/" target="_blank">Bootstrap admin template</a> from Bootstrapdash.com</span> -->
            </div>
          </footer>
          <!-- partial -->
        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        document.querySelectorAll(".view-activity-btn").forEach(button => {
            button.addEventListener("click", function () {
                ...
                window.location.href = "/admin/user-activity/" + userId + "?name=" + encodeURIComponent(userName);
            });
        });
    });
</script>
    ...
    <script>
      ...
      console.log(userId);
      var userName = button.closest('tr').find('td:first-child span').text();
      ...
      $(document).ready(function() {
        ...
        setTimeout(function() {
            $('.alert-success').fadeOut(); // Use fadeOut for a smoother effect
        }, 5000);
      });
